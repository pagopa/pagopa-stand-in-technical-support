...
public class CosmosEventsRepository {
  ...
  public List<CosmosEvent> find(Optional<String> station, LocalDate dateFrom, LocalDate dateTo) {
    ...
    do {
      Iterable<FeedResponse<CosmosEvent>> feedResponses =
          query(q).iterableByPage(continuationToken, 100);
